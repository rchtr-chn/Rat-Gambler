...
public class GameManagerScript : MonoBehaviour
{
    ...
    public void InitializeGameplayManagers()
    {
        ...
        {
            GameObject prefab = Resources.Load<GameObject>("Prefabs/Player-DeckManager");
            if (prefab == null)
            {
        ...
        {
            GameObject prefab = Resources.Load<GameObject>("Prefabs/Enemy-DeckManager");
            if (prefab == null)
            {
                Debug.LogError("DeckManager prefab not found in Resources/Prefabs");
            }
        ...
        {
            GameObject prefab = Resources.Load<GameObject>("Prefabs/CookieManager");
            if (prefab == null)
            {
