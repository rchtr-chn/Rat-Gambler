...
var ASM_CONSTS = {
  3000044: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3000099: ($0) => { performance.now = function() { return $0; }; },  
 3000147: ($0) => { performance.now = function() { return $0; }; },  
 3000195: () => { performance.now = Module['emscripten_get_now_backup']; }
};
